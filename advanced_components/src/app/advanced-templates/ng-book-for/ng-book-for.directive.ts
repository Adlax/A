import { Directive, IterableDiffers, IterableDiffer, ViewRef, ViewContainerRef, TemplateRef, ChangeDetectorRef, DoCheck, Input } from '@angular/core';
